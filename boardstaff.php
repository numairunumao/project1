            ...
            <div class="panel-body">
                <form method="post" action="insert.php" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        <tr>
                            <td><label class="control-label"> วันที่ คณะอนุกรรมการจัดหาที่ดินส่งข้อมูลให้ คทช.จังหวัด
                                    c3</label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="checkbox" name="c4"/>การตรวจสอบและพิจารณาของ
                                คทช.จังหวัด
                            </td>
                        </tr>

                        <tr>
                            <td><label class="control-label"> วันที่ คทช.จังหวัด ส่งรายงานผลให้คณะอนุกรรมการจัดหาที่ดิน
                                    c5</label>
                            </td>
                        ...
                        <tr>
                            <td><label class="control-label"> วันที่ได้รับการเห็นชอบคณะอนุกรรมการจัดหาที่ดิน c6</label>
                            </td>
                        ...
                        <tr>
                            <td><label class="control-label"> พื้นที่ที่ได้รับอนุญาติใช้ประโยชน์รวม (ไร่) d3 </label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><input class="form-control" type="checkbox" name="d17" size="small">อยู่ระหว่างการกำหนดหลักเกณฑ์
                            </td>
                        ...
                        <tr>
                            <td><label class="control-label"> วันที่ คณะอนุกรรมการจัดที่ดินส่งข้อมูลให้ คทช.จังหวัด
                                    d18</label>
                            </td>
                        ...
                        <tr>
                            <td><label class="control-label"> การตรวจสอบและจัดทำข้อมูลคนของ คทช.จังหวัด d19 </label>
                            </td>
                            <td><input class="form-control" type="checkbox" name="d19"/>อยู่ระหว่าง
                                การตรวจสอบและจัดทำข้อมูล
                            </td>
                        </tr>


                        <tr>
                            <td><label class="control-label"> วันที่ คทช.จังหวัด ส่งข้อมูลคนให้คณะอนุกรรมการจัดที่ดิน
                                    d20</label>
                            </td>
                        ...
                        <tr>
                            <td><label class="control-label"> วันที่ คทช.จังหวัด
                                    ส่งรายงานผลให้คณะอนุกรรมการส่งเสริมและพัฒนาอาชีพ
                                    e2</label>
                            </td>
